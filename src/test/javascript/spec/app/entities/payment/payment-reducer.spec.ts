...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    it('should set state to loading', () => {
      testMultipleTypes([REQUEST(ACTION_TYPES.FETCH_PAYMENT_LIST), REQUEST(ACTION_TYPES.FETCH_PAYMENT)], {}, state => {
        expect(state).toMatchObject({
          errorMessage: null,
          updateSuccess: false,
          loading: true
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.FETCH_PAYMENT),
          FAILURE(ACTION_TYPES.CREATE_PAYMENT),
          FAILURE(ACTION_TYPES.UPDATE_PAYMENT),
  ...
  describe('Successes', () => {
    it('should fetch all entities', () => {
      ...
      expect(
        reducer(undefined, {
          type: SUCCESS(ACTION_TYPES.FETCH_PAYMENT_LIST),
          payload
        })
      ).toEqual({
        ...initialState,
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.UPDATE_PAYMENT actions', async () => {
      const expectedActions = [
        ...
        {
          type: SUCCESS(ACTION_TYPES.UPDATE_PAYMENT),
          payload: resolvedObject
        },
        {
          type: REQUEST(ACTION_TYPES.FETCH_PAYMENT_LIST)
