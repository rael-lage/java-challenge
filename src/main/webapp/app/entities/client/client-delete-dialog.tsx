...
export class ClientDeleteDialog extends React.Component<IClientDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this.props.clientEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="javaChallengeApp.client.delete.question">Are you sure you want to delete this Client?</ModalBody>
        <ModalFooter>
